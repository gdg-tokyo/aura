  ...
  <v-container class="pa-0">
    <v-layout wrap align-center justify-center row fill-height class="my-3">
      <v-flex xs12 sm2 md2 lg2 class="pa-2">
        <v-img
          src="/img/devfest2020/kit/image08.png"
          lazy-src="/img/devfest2020/kit/image08.png"
          width="250"
          style="margin:0 auto;"
        ></v-img>
      </v-flex>
      ...
      <v-flex xs12 sm2 md2 lg2 class="pa-2">
        <v-img
          src="/img/devfest2020/kit/image09.png"
          lazy-src="/img/devfest2020/kit/image09.png"
          width="250"
          style="margin:0 auto;"
        ></v-img>
      </v-flex>
...
export default {
  ...
  method: {
    getDetailLink(speakerID){
      return '/devfest2020/session/' + speakerID
    }
  },
  mixins: [Mixin]
};
