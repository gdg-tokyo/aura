  ...
  <v-container class="pa-0">
    ...
    <v-layout wrap align-center justify-center row fill-height class="my-3">
      <v-flex xs12 sm2 md2 lg2 class="pa-2">
        <v-img
          src="/img/devfest2020/kit/image02.png"
          lazy-src="/img/devfest2020/kit/image02.png"
          width="250"
          style="margin:0 auto;"
        ></v-img>
      </v-flex>
      ...
      <v-flex xs12 sm2 md2 lg2 class="pa-2">
        <v-img
          src="/img/devfest2020/kit/image03.png"
          lazy-src="/img/devfest2020/kit/image03.png"
          width="250"
          style="margin:0 auto;"
        ></v-img>
      </v-flex>
    ...
    <v-layout wrap align-center justify-center row fill-height class="my-3">
      <v-flex xs10 sm8 md6 lg4 class="text-xs-center">
        <v-img src="/img/devfest2020/gdgtokyo.png"
        lazy-src="/img/devfest2020/gdgtokyo.png"
        ></v-img>
      </v-flex>
