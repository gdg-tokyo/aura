  ...
  <v-container class="pa-0">
    ...
    <v-layout wrap align-center justify-center row fill-height class="my-0">
      <v-flex xs12 sm2 md2 lg2 class="pa-2 text-xs-center">
        <v-img
          src="/img/devfest2020/kit/and_icon.png"
          lazy-src="/img/devfest2020/kit/and_icon.png"
          class
          width="80"
          style="margin:0 auto;"
        ></v-img>
      ...
      <v-flex xs12 sm2 md2 lg2 class="pa-2 text-xs-center">
        <v-img
          src="/img/devfest2020/kit/go_icon.png"
          lazy-src="/img/devfest2020/kit/go_icon.png"
          class
          width="80"
          style="margin:0 auto;"
        ></v-img>
